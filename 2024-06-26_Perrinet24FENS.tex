...
\footercontent{
  ...
  \href{mailto:\EmailLP}{\EmailLP} \includegraphics[height=2cm]{figures/qr_code.png} 
  }
...
\begin{figure}%[t]%[h!]
% \begin{center}
  \includegraphics[width=.50\colwidth]{figures/THC_toy-a_k.pdf}
  \includegraphics[width=.50\colwidth]{figures/THC_toy-b.pdf}
  \\
  \includegraphics[width=.50\colwidth]{figures/THC_toy-c.pdf}
  \includegraphics[width=.50\colwidth]{figures/THC_toy-a.pdf} 
% \end{center}
